...
const svgTimes = document.querySelector("#svg-times");
const svgKey = document.querySelector("#svg-key");
...
const clickCircleSvgOne = () => {
  if (screen.width <= 768) {
    ...
    svgTimes.classList.remove("active");
...
const clickCircleSvgThree = () => {
  if (screen.width <= 768) {
    if (
      ...
      svgKey.classList.toggle("active");
