const blockPresentationMain = document.querySelector(
  ...
  const blockCollapseOpenedTwo = document.querySelector("#collapse-two");
   const blockCollapseOpenedThree = document.querySelector("#collapse-three");
  ...
  rotateArrowOne.addEventListener("click", (event) => {
    ...
    rotateArrowThree.classList.remove("active");
    blockCollapseThree.classList.remove("backgroundColor");

    blockCollapseOpenedTwo.style.display = "none";
    blockCollapseOpenedThree.style.display = "none";
  ...
  rotateArrowThree.addEventListener("click", (event) => {
    ...
    if (blockCollapseOpenedThree.style.display == "block") {
      ...
      blockCollapseOpenedThree.style.display = "block";
    }
    ...
    blockCollapseThree.style.transition = "0.7s ease-in-out 0s";
    blockCollapseOpenedThree.style.transition = "0.2s ease-in-out 0s";
